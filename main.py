...
PROMPT_LIBRARY_PRIMARY_WRITE = str(os.environ.get("PROMPT_LIBRARY_PRIMARY_WRITE", "db")).strip().lower()  # 数据 PR-8（Wave 3-G）PromptLibrary 主写门禁 · 数据 PR-21（Wave 3-N.5 主线 A）反转默认为 "db"；Settings 层校验值域 {"json","db"}；HTTP 不可修改
